...
export default function ServicesList({ onQuoteClick }: ServicesProps) {
  ...
  return (
    <section id="services" className="py-24 bg-navy-950 relative scroll-mt-12 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <p className="text-slate-350 mt-4 text-sm sm:text-base leading-relaxed">
        ...
        >
          {SERVICES_DATA.map((service, index) => (
            <motion.div
              ...
              className="bg-navy-900 border border-slate-800/80 rounded-2xl shadow-md overflow-hidden transition-all duration-300 flex flex-col h-full group hover:border-gold-500/40"
            >
              {/* Animated top stripe color accent */}
              <div className="h-[5px] w-full bg-gradient-to-r from-gold-500 via-amber-500 to-gold-600 origin-left scale-x-100 transition-transform duration-500" />
              
              <div className="p-8 flex flex-col flex-grow">
                {/* Icon & Specs Bar */}
                <div className="bg-gradient-to-r from-gold-500 to-gold-600 px-4 py-3 rounded-xl flex items-center justify-between mb-6 shadow-sm ring-4 ring-gold-500/10 group-hover:ring-gold-500/20 transition-all duration-300 w-full">
                  ...
                  <span className="text-[10px] font-mono font-bold bg-navy-950/20 text-navy-950 px-2.5 py-1 rounded uppercase tracking-wider">
                ...
                {/* Service Title */}
                <h3 className="font-display font-bold text-xl text-white mb-3 group-hover:text-gold-400 transition-colors">
                  {service.title}
                </h3>

                {/* Main Description */}
                <p className="text-slate-350 text-xs sm:text-sm leading-relaxed mb-6 flex-grow">
                  {service.description}
                </p>

                {/* Production Specs box */}
                <div className="mb-6 bg-navy-950 p-4 rounded-xl border border-slate-800/80">
                  <div className="flex items-center text-[10px] font-mono text-slate-400 uppercase tracking-wider mb-2.5">
                    <Zap className="h-3 w-3 text-gold-500 mr-1.5 flex-shrink-0 animate-pulse" />
                ...
                <div className="space-y-2 mb-6">
                  {service.benefits.map((benefit, idx) => (
                    <div key={idx} className="flex items-center space-x-2 text-xs sm:text-sm text-slate-300">
                      <div className="h-4.5 w-4.5 rounded-full bg-emerald-500/10 border border-emerald-400/20 flex items-center justify-center flex-shrink-0">
                ...
                <div className="border-t border-slate-800 pt-5 mt-auto flex items-center gap-2.5 bg-gold-500/10 border border-gold-500/20 rounded-xl px-4 py-3">
        ...
        <motion.div 
          ...
          className="rounded-2xl p-8 sm:p-12 text-center text-white mt-16 shadow-2xl overflow-hidden relative group"
        ...
        >
          ...
          <div className="absolute top-0 right-0 w-72 h-72 bg-gradient-to-b from-gold-500/10 to-transparent rounded-full blur-3xl pointer-events-none group-hover:scale-110 transition-transform duration-1000" />
          ...
          <div className="relative z-10 max-w-2xl mx-auto space-y-4">
            ...
            <p className="text-slate-350 text-xs sm:text-sm leading-relaxed max-w-xl mx-auto">
            ...
            <div className="pt-4">
              <button
                ...
                className="bg-gradient-to-r from-gold-500 to-gold-600 text-white font-bold px-8 py-3.5 rounded-xl text-xs uppercase tracking-wider shadow-lg hover:brightness-110 active:scale-[0.98] transition-all flex items-center space-x-2.5 mx-auto cursor-pointer"
              >
