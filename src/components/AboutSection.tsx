    ...
    <section id="about" className="scroll-mt-12 bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <motion.div
          ...
          className="bg-gradient-to-br from-slate-50 to-white rounded-3xl p-8 sm:p-12 border border-slate-200 shadow-xl text-center"
        >
          <div className="max-w-3xl mx-auto space-y-6">
            ...
            {/* Heading */}
            <h2 className="font-display font-black text-3xl sm:text-4xl leading-tight" style={{ color: "#1B2A6B" }}>
              Ready to Get Started?
            </h2>

            {/* Description */}
            <p className="text-slate-600 text-base sm:text-lg leading-relaxed max-w-2xl mx-auto">
              Submit your order now and get a free quote with a detailed digital file report. 
              Our team is ready to bring your designs to life with precision and speed.
            </p>

            {/* Toggle Buttons - Equal Width Side by Side */}
            <div className="inline-flex items-center justify-center gap-0 pt-4 bg-slate-100 rounded-full p-1 shadow-lg">
              <button
            ...
            {/* Trust badges */}
            <div className="flex flex-wrap items-center justify-center gap-4 pt-6 text-xs text-slate-500">
              <div className="flex items-center gap-1.5">
                <ShieldCheck className="h-4 w-4" style={{ color: "#1cb8df" }} />
                <span>100% Secure</span>
              </div>
              <div className="w-1 h-1 rounded-full bg-slate-300" />
              <div className="flex items-center gap-1.5">
                <Clock className="h-4 w-4" style={{ color: "#1cb8df" }} />
                <span>2-4 Hour Turnaround</span>
              </div>
              <div className="w-1 h-1 rounded-full bg-slate-300" />
              <div className="flex items-center gap-1.5">
                <Star className="h-4 w-4" style={{ color: "#1cb8df" }} />
